...
- **連続再生（オートプレイ）** — 日本語読み上げ完了後に自動で次の文へ。YouTube風デザインのスイッチでON/OFF。
...
現在 **26件の単体テスト** が実装されています（FileHandler: 7件、ViewModel: 18件、基本テスト: 1件）。すべてパスすることを確認済みです。
...
8. プログレスバー右下の **連続再生スイッチ** をオンにすると、自働で次の文へ進むようになる
